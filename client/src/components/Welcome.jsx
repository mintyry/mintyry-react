                    ...
                    (
                        !showMessage ?
                            ...
                            <svg width="519" height="87" viewBox="0 0 519 87" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M30.55 17.489C30.55 1.70168 34.5682 49.1506 40.4315 63.8088" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M12.6396 48.9865C-3.19998 48.9865 41.747 35.9596 54.6362 26.753" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M65.1354 39.7225C59.7932 34.9739 53.9233 69.1769 68.7037 60.5836C75.4623 56.6542 74.592 39.7225 65.753 39.7225" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M123.807 39.1049C123.807 35.2996 130.943 78.3595 131.218 63.1912C131.375 54.5656 134.827 47.2195 136.914 39.1049C138.648 32.3609 139.249 45.8605 140.139 48.4032C146.646 66.9947 146.834 63.8194 154.961 46.8249C158.738 38.9292 160.05 70.3764 162.716 65.044" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M170.745 47.7513C164.47 47.7513 178.675 60.1033 184.949 60.1033" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M189.89 25.5178C190.336 25.0158 189.113 37.9822 188.655 41.3008C187.66 48.517 187.852 56.1146 186.322 63.1912C184.879 69.8629 184.332 90.3978 184.332 83.5719" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M241.313 7.40399C239.263 25.8611 249.715 81.0497 249.715 62.479C249.715 57.6755 258.116 41.8373 258.116 44.8363C258.116 49.4815 264.733 64.0029 268.197 53.611" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M287.52 39.3288C287.091 35.8926 275.322 47.7969 279.959 58.2317C284.723 68.95 297.299 40.1689 286.68 40.1689" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M308.524 42.6893C307.882 37.5573 306.805 53.0964 307.73 58.185C309.142 65.9523 308.524 56.3479 308.524 53.6576C308.524 44.6751 315.728 41.0091 323.646 41.0091" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M345.679 38.5636C339.494 44.0609 333.689 53.3639 338.048 62.0825C341.412 68.8096 366.841 54.5564 359.32 54.5564" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M372.961 41.3859C372.961 46.3141 371.813 57.3808 375.678 61.2462C377.53 63.0976 374.372 53.7845 374.372 50.7934C374.372 42.6287 384.697 42.3266 390.835 42.3266" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M401.183 43.2674C401.183 36.6564 403.274 61.0895 409.885 61.0895C415.313 61.0895 416.706 45.2012 416.706 41.6211C416.706 36.8025 415.495 51.5186 417.071 56.0721C419.722 63.7291 425.421 58.6657 429.876 56.4379" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M436.932 38.0932C436.932 36.0812 439.6 45.3208 440.799 47.3963C445.67 55.8262 453.965 64.1268 463.273 66.7863" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M452.454 33.8598C452.454 25.3498 448.725 50.4929 446.078 58.5808C445.313 60.9177 441.303 71.4214 443.047 70.5493" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M472.681 63.964C477.029 64.5851 472.491 64.9047 474.092 64.9047" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M485.851 64.4344C487.954 62.0684 484.818 69.1777 488.177 65.8194C488.723 65.2736 485.976 65.1246 486.321 64.4344" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                                <path d="M499.492 64.4344C499.431 63.9424 498.541 65.7252 499.022 65.8455" stroke="#A7FFCA" stroke-width="3" stroke-linecap="round" />
                            </svg>
